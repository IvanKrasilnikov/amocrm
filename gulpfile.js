...
gulp.task('js-BLOCKS-concat', function() {
  return gulp.src(devDir + '/BLOCKS/**/*.js')
    .pipe(concat('main.js'))
    .pipe(gulp.dest(devDir + '/js/'));
});

gulp.task('js-BLOCKS-concat:watch', function() {
  gulp.watch(devDir + '/BLOCKS/**/*.js', ['js-BLOCKS-concat']);
});
